...
class ContactosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'message' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2021-10-28 14:31:57',
                'modified' => '2021-10-28 14:31:57',
            ],
        ];
        parent::init();
    }
