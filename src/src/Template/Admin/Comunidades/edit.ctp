...
<section id="editComunidades" class="moduleContent">
  <div class="title borderBottom">
      <h2>Editar comunidades</h2>
  </div>
  <?= $this->Flash->render('message_comunidades');?>
  <div class="bannerContainer">
    <?php
      ...
      ?>
    <?= $this->Form->create($editComunidad, ['class'=>'addBanner','type' => 'file']) ?>
      <?php
        ...
        echo $this->Form->control('description',['required'=>false,'label'=>['class'=>'form-control-label', 'text'=>'Descripción español'],'placeholder'=>'Descripción español']);
        echo "<div class='buttons'>";
          echo $this->Html->link($this->Form->button('Cancelar',['class'=>'btn btnDanger', 'type'=>'button']), ['controller' => 'Comunidades', 'action' => 'index'], ['escape' => false]);
