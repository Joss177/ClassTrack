<section id="addGaleria" class="moduleContent">
  ...
  <div class="bannerContainer">
    <?php
      ...
      ?>
    <?= $this->Form->create($editGaleria, ['class'=>'addGaleria','type' => 'file']) ?>
      <?php
        echo $this->Form->control('img',['type'=>'file','required'=>false,'label'=>['class'=>'form-control-file', 'text'=>'Imagen']]);
        echo "<div class='buttons'>";
          echo $this->Html->link($this->Form->button('Cancelar',['class'=>'btn btnDanger', 'type'=>'button']), ['controller' => 'Galerias', 'action' => 'index'], ['escape' => false]);
